...
public class Paciente {
    ...
    public Paciente(long id, String nombre, LocalDate anioNacimiento, String ciudad, String correo, String telefono, String ips, Boolean tienePoliza, String grupoIngreso, LocalDate fechaAfiliacion, Medico medico, List<Medicamento> medicamentos, List<Enfermedad> enfermedades, List<signoVital> signosVitales) {
        this.id = id;
        this.nombre = nombre;
